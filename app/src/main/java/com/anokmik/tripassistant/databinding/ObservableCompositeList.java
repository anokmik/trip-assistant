...
public final class ObservableCompositeList<T> implements ObservableList<T>, AsyncCompositeList.AsyncCompositeListCallback {
    ...
    public ObservableCompositeList(@NonNull final List<T> list) {
        this.list = list;
        if (list instanceof AsyncCompositeList) {
            ((AsyncCompositeList) list).setCallback(this);
        }
    }
